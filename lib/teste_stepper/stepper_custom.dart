...
class _StepperCustomState extends State<StepperCustom> with TickerProviderStateMixin {
  ...
  BoxDecoration _buildCircleDecoration(int index) {
  ...
  //   if (!_isDark()) {
  //     return widget.steps[index].isActive ? colorScheme.primary : colorScheme.onSurface;
  //   } else {
  ...
  Widget _buildCircle(int index, bool oldState) {
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: _buildCircleDecoration(index),
        child: Center(
