...
class ConsolidadoRadarGrafico extends StatefulWidget {
  const ConsolidadoRadarGrafico({Key? key}) : super(key: key);

  @override
  _ConsolidadoRadarGraficoState createState() => _ConsolidadoRadarGraficoState();
}

class _ConsolidadoRadarGraficoState extends State<ConsolidadoRadarGrafico> {
