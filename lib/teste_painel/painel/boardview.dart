...
class BoardView extends StatefulWidget {
  ...
  BoardView({Key? key, this.itemInMiddleWidget,this.scrollbar,this.scrollbarStyle, required this.boardViewController,this.dragDelay=300,this.onDropItemInMiddleWidget, this.isSelecting = false, this.lists, this.width = 280, this.middleWidget, this.bottomPadding}) : super(key: key);
